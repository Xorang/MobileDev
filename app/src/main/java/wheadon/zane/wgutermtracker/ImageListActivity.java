        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setDataAndType(FileProvider.getUriForFile(ImageListActivity.this, ImageListActivity.this
                        .getApplicationContext().getPackageName() + ".wheadon.zane.wgutermtracker.provider", file), "image/*");
                Toast.makeText(ImageListActivity.this, FileProvider.getUriForFile(ImageListActivity.this, ImageListActivity.this.getApplicationContext().getPackageName() + ".wheadon.zane.wgutermtracker.provider", file).toString(), Toast.LENGTH_LONG).show();
