...
public class TermListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private boolean createSampleData() {
        Uri term1Uri = DataManager.insertTerm(this, "Fall 2018", "2018-07-01", "2018-12-31", 1);
        Uri term2Uri = DataManager.insertTerm(this, "Spring 2019", "2019-01-01", "2019-06-30", 0);
        Uri term3Uri = DataManager.insertTerm(this, "Fall 2019", "2019-07-01", "2019-12-31", 0);
        Uri term4Uri = DataManager.insertTerm(this, "Spring 2020", "2020-01-01", "2020-06-30", 0);
        Uri term5Uri = DataManager.insertTerm(this, "Fall 2020", "2020-07-01", "2020-12-31", 0);
        Uri term6Uri = DataManager.insertTerm(this, "Spring 2021", "2021-01-01", "2021-06-30", 0);

        Uri course1Uri = DataManager.insertCourse(this, Long.parseLong(term1Uri.getLastPathSegment()),
                "C196: Mobile Application Development", "2018-10-01", "2018-11-01",
                "Pubali Banerjee", "(801) 924-4710", "pubali.banerjee@wgu.edu",
                CourseStatus.IN_PROGRESS);

        Uri course2Uri = DataManager.insertCourse(this, Long.parseLong(term1Uri.getLastPathSegment()),
                "C868: Software Development Capstone", "2018-11-02", "2018-11-24",
                "Course Mentor Group", " ", "ugcapstoneit@wgu.edu",
        ...
        Uri ass1Uri = DataManager.insertAssessment(this, Long.parseLong(course1Uri.getLastPathSegment()), "ABM1", "Mobile Application Development",
                "As a competent mobile application developer, your understanding of mobile application structure " +
                        ...
                        "This application will use a SQLite database.", "2018-11-01 2:30 PM");


        Uri ass2Uri = DataManager.insertAssessment(this, Long.parseLong(course2Uri.getLastPathSegment()), "EZP1", "Software Development Capstone",
                "This task is the design, development, and implementation of the software application that was " +
                "approved by a course mentor. Your work for this task will not be evaluated until the appropriate forms " +
                "from Task 1 have been submitted and evaluated.",  "2018-11-24 10:30 AM");
